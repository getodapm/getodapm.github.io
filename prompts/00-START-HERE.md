...
Welcome. You're about to build your own **open, market-derived pricing model** for restoration work — no coding, no proprietary list, no subscription. You'll do it by running a short series of prompts with an AI assistant (Claude), answering questions about your trade and your region as you go.
